        ...
        <View style={[styles.vestContainer, theme.shadows.lg]}>
          <Svg width="160" height="180" viewBox="0 0 160 180">
            ...
            <G transform="translate(75, 70)">
              <Path d="M5 0 L5 8 L9 4 L5 0 Z M5 8 L5 16 L9 12 L5 8 Z M1 6 L9 14 M1 10 L9 2" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
            </G>

            {[
              { x: 65, y: 55 }, { x: 95, y: 55 }, { x: 65, y: 105 }, { x: 95, y: 105 }, { x: 80, y: 125 }
            ].map((dot, index) => (
              <Circle key={index} cx={dot.x} cy={dot.y} r="3" fill="#10B981" opacity={0.8} />
            ))}
